...
<div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
	...
	<nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
		...
		{{-- agence comertial performance start --}}

		<a class="mdl-navigation__link {{ Request::is('performance_comercial') ? 'mdl-navigation__link--current' : null }}" href="/performance_comercial">
			<i class="material-icons mdl-badge mdl-badge--overlap" role="presentation">assessment</i>Performance Comercial
			
		</a>
		{{-- agence comertial performance end --}}
		@role('admin')
